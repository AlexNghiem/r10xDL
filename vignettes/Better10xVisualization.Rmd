...
plot <- cite %>%
  normalize() %>% #we will log-normalize the antibody capture data
  runUMAP(feature_set = proteinRows) %>% #only use the 14 proteins for computing the umap
  plotUMAP #this takes the UMAP data stored by runUMAP and converts it to a ggplot object
```
